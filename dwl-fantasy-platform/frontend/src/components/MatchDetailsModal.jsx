  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ margin: '0.5rem 0 0', opacity: 0.9 }}>
              ...
              {<span style={{ marginLeft: '0.5rem' }}>🏆 Winner: <strong>{result}</strong></span>}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Team Points Summary - Made scrollable horizontally on mobile */}
        <div style={{
          padding: '1rem',
          background: '#0d0d1a',
        ...
        {/* Main Match Table - Made scrollable */}
        <div style={{
          padding: '1.5rem',
          overflowY: 'auto',
          overflowX: 'auto',
          ...
          <div className="scorecard-wrapper">
            <table className="scorecard-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
